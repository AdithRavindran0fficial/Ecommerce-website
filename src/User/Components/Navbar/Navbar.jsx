...
function Navbar() {
  ...
  return (
    <header className='border-b-4 border-black px-12 py-8  absolute w-full  h-9 '>
        <nav className=' flex  justify-between items-center -mt-4  max-container '>
            ...
            <ul className=' flex gap-4 justify-end pl-32 list-none max-lg:hidden'>
                ...
                {userLog?<li><Link to={"/login"}><div className="w-15 h-15 rounded-full overflow-hidden border-2 border-gray-300">
        <img src='' alt={name} className="w-full h-full object-cover"onClick={handlelog} />
      </div>
    </Link></li>:
